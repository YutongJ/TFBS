...
ctcf.Cluster <- function(jj){
  ...
  if(!dir.exists(paste0(wd3.6,"aft/"))) dir.create(paste0(wd3.6,"aft/"))
  fn = paste0(wd3.4,"list.aft10/aft",seq(1:10),".rda")
  sn = paste0(wd3.6,"aft/top",ii,"aft",seq(1:10),".alt3.rda")
  sn2= paste0(wd3.6,"aft/top",ii,"aft",seq(1:10),".alt3.csv")
  for(i in 1:10){
    print(i)
    load(fn[i])
