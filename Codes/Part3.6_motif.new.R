...
ctcf.Cluster <- function(jj){
  ...
  if(!dir.exists(paste0(wd3.6,"motif/"))) dir.create(paste0(wd3.6,"motif/"))
  fn = paste0(wd3.4,"list.motif15/motif",seq(1:15),".rda")
  sn = paste0(wd3.6,"motif/top",ii,"motif",seq(1:15),".alt3.rda")
  sn2= paste0(wd3.6,"motif/top",ii,"motif",seq(1:15),".alt3.csv")
  for(i in 1:15){
    print(i)
    load(fn[i])
